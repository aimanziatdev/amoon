...
export default function Home() {
  ...
  return (
    <div className="min-h-screen thunder-bg">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-thunder-900 dark:text-white mb-6">
                À Propos d'<span className="thunder-text">Amoon</span>
              </h2>
              ...
              <Link href="/contact" className="btn-primary thunder-glow">
                En Savoir Plus
              </Link>
            </div>
            <div className="relative">
              <div className="aspect-square thunder-gradient rounded-2xl flex items-center justify-center thunder-glow">
                <Zap className="text-8xl text-primary-400 animate-thunder" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-thunder-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold thunder-text">Amoon</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-thunder-400 hover:text-primary-400 transition-colors">Accueil</Link></li>
                <li><Link href="/collections" className="text-thunder-400 hover:text-primary-400 transition-colors">Collections</Link></li>
                <li><Link href="/contact" className="text-thunder-400 hover:text-primary-400 transition-colors">Contact</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4">Service Client</h3>
              <ul className="space-y-2">
                <li><Link href="/contact" className="text-thunder-400 hover:text-primary-400 transition-colors">Nous Contacter</Link></li>
                <li><Link href="/contact" className="text-thunder-400 hover:text-primary-400 transition-colors">Informations de Livraison</Link></li>
                <li><Link href="/contact" className="text-thunder-400 hover:text-primary-400 transition-colors">Retours</Link></li>
              </ul>
            </div>
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-thunder-400 hover:text-primary-400 transition-colors">
                  Instagram
                </a>
                <a href="#" className="text-thunder-400 hover:text-primary-400 transition-colors">
                  Facebook
          ...
          <div className="border-t border-thunder-800 mt-8 pt-8 text-center">
            <p className="text-thunder-400">
              © 2024 Amoon. Tous droits réservés.
            </p>
          </div>
        </div>
      </footer>
